    ...
    <main className="p-8">
      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8">
          {/* Property Card 1 */}
          <div className="bg-white dark:bg-slate-900 rounded-[24px] overflow-hidden shadow-sm hover:shadow-md transition-shadow group border border-neutral-border dark:border-slate-800 flex flex-col h-full">
            ...
            <div className="p-6 space-y-4 flex flex-col flex-grow">
              <div>
                <h3 className="text-xl font-bold heading-font mb-1 truncate">742 Evergreen Terrace</h3>
                <p className="text-sm text-slate-500 flex items-center">
                  <span className="material-icons text-sm mr-1">location_on</span>
                  Springfield, IL 62704
                </p>
              </div>
              <div className="grid grid-cols-2 gap-4 py-4 border-y border-neutral-border/50 dark:border-slate-800">
                <div className="space-y-1 flex flex-col h-full">
                  <p className="text-[10px] uppercase font-bold text-slate-400 tracking-wider">Date &amp; Time</p>
                  <p className="text-sm font-semibold">Oct 24 • 10:00 AM</p>
                </div>
                <div className="space-y-1 flex flex-col h-full">
                ...
                <div className="space-y-1 flex flex-col h-full">
                  <p className="text-[10px] uppercase font-bold text-slate-400 tracking-wider">Photographer</p>
                ...
                <div className="space-y-1 flex flex-col h-full">
                  <p className="text-[10px] uppercase font-bold text-slate-400 tracking-wider">Package</p>
                  <p className="text-sm font-semibold">Premium HDR</p>
                </div>
              </div>
          ...
          <div className="bg-white dark:bg-slate-900 rounded-[24px] overflow-hidden shadow-sm hover:shadow-md transition-shadow group border border-neutral-border dark:border-slate-800 flex flex-col h-full">
            ...
            <div className="p-6 space-y-4 flex flex-col flex-grow">
              <div>
                <h3 className="text-xl font-bold heading-font mb-1 truncate">124 Conch Street</h3>
                <p className="text-sm text-slate-500 flex items-center">
                  <span className="material-icons text-sm mr-1">location_on</span>
              ...
              <div className="grid grid-cols-2 gap-4 py-4 border-y border-neutral-border/50 dark:border-slate-800">
                <div className="space-y-1 flex flex-col h-full">
                  <p className="text-[10px] uppercase font-bold text-slate-400 tracking-wider">Date &amp; Time</p>
                  <p className="text-sm font-semibold">Oct 25 • 02:30 PM</p>
                </div>
                <div className="space-y-1 flex flex-col h-full">
                  <p className="text-[10px] uppercase font-bold text-slate-400 tracking-wider">Agent</p>
                  <p className="text-sm font-semibold">Michael Scott</p>
                </div>
                <div className="space-y-1 flex flex-col h-full">
                  <p className="text-[10px] uppercase font-bold text-slate-400 tracking-wider">Photographer</p>
                  <div className="flex items-center gap-1.5">
                    ...
                    <p className="text-sm font-semibold">Dave White</p>
                  </div>
                </div>
                <div className="space-y-1 flex flex-col h-full">
                  <p className="text-[10px] uppercase font-bold text-slate-400 tracking-wider">Package</p>
                  <p className="text-sm font-semibold">Standard + Drone</p>
                </div>
              </div>
              <div className="flex-grow"></div>
          ...
          <div className="bg-white dark:bg-slate-900 rounded-[24px] overflow-hidden shadow-sm hover:shadow-md transition-shadow group border border-neutral-border dark:border-slate-800 flex flex-col h-full">
            ...
            <div className="p-6 space-y-4 flex flex-col flex-grow">
              <div>
                <h3 className="text-xl font-bold heading-font mb-1 truncate">42 Wallaby Way</h3>
                <p className="text-sm text-slate-500 flex items-center">
                  <span className="material-icons text-sm mr-1">location_on</span>
                  Sydney, NSW 2000
                </p>
              ...
              <div className="grid grid-cols-2 gap-4 py-4 border-y border-neutral-border/50 dark:border-slate-800">
                <div className="space-y-1 flex flex-col h-full">
                  <p className="text-[10px] uppercase font-bold text-slate-400 tracking-wider">Date &amp; Time</p>
                  <p className="text-sm font-semibold">Oct 26 • 09:00 AM</p>
                </div>
                <div className="space-y-1 flex flex-col h-full">
                  <p className="text-[10px] uppercase font-bold text-slate-400 tracking-wider">Agent</p>
                  <p className="text-sm font-semibold">Elena Fisher</p>
                </div>
                <div className="space-y-1 flex flex-col h-full">
                  <p className="text-[10px] uppercase font-bold text-slate-400 tracking-wider">Photographer</p>
                  <div className="flex items-center gap-1.5">
                    ...
                    <p className="text-sm font-semibold">Nathan Moon</p>
                  </div>
                </div>
                <div className="space-y-1 flex flex-col h-full">
                  <p className="text-[10px] uppercase font-bold text-slate-400 tracking-wider">Package</p>
                  <p className="text-sm font-semibold">Virtual Tour 3D</p>
                </div>
              </div>
              <div className="flex-grow"></div>
